...
router.post('/post/:postId/report', [requireSignin], reportPost)

router.get('/post/:postId', [requireSignin], showPost)
router.post('/:channelId/post/', [requireSignin, storePostValidator, isFollowedChannel, withAuthUser], storePost)
router.get('/:channelId/post/', [requireSignin], getPosts)
